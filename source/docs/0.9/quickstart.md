...
![Screenshot of the Flapjack Web UI](http://flapjack.io/images/quickstart/web-ui.png)
...
![CLI](http://flapjack.io/images/quickstart/term-flapjack-help.png)
...
![Flapjack's architecture](http://flapjack.io/images/quickstart/architecture.png)
...
![Checks](http://flapjack.io/images/quickstart/checks-from-nagios.png)
...
![Contacts - List](http://flapjack.io/images/quickstart/contacts-ada-and-charles.png)

Selecting [Ada](http://localhost:3080/contacts/21) should give you something like:

![Contact - Ada Lovelace](http://flapjack.io/images/quickstart/contact-ada.png)
...
![Entity - my-app-01.example.com](http://flapjack.io/images/quickstart/entity-my-app-01-no-checks.png)
