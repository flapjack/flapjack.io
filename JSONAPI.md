...
<ul>
  <li><a href="jsonapi/contacts#get_contacts_id_notification_rules">GET /contacts/CONTACT_ID/notification_rules</a></li>
  <li><a href="jsonapi/contacts#get_notification_rules_id">GET /notification_rules/RULE_ID</a></li>
  <li><a href="jsonapi/contacts#post_notification_rules">POST /notification_rules</a></li>
  <li><a href="jsonapi/contacts#put_notification_rules_id">PUT, DELETE /notification_rules/RULE_ID</a></li>
</ul>

### Misc

<ul>
  <li><a href="jsonapi/contacts#post_contacts_atomic">POST /contacts_atomic</a></li>
  <li><a href="jsonapi/contacts#get_contacts_id_timezone">GET /contacts/CONTACT_ID/timezone</a></li>
  <li><a href="jsonapi/contacts#put_contacts_id_timezone">PUT, DELETE /contacts/CONTACT_ID/timezone</a></li>
  <li><a href="jsonapi/contacts#get_contacts_id_tags">GET /contacts/CONTACT_ID/tags</a></li>
  <li><a href="jsonapi/contacts#post_contacts_id_tags">POST /contacts/CONTACT_ID/tags</a></li>
  <li><a href="jsonapi/contacts#delete_contacts_id_tags">DELETE /contacts/CONTACT_ID/tags</a></li>
  <li><a href="jsonapi/contacts#get_contacts_id_entitytags">GET /contacts/CONTACT_ID/entity_tags</a></li>
  <li><a href="jsonapi/contacts#post_contacts_id_entitytags">POST /contacts/CONTACT_ID/entity_tags</a></li>
  <li><a href="jsonapi/contacts#delete_contacts_id_entitytags">DELETE /contacts/CONTACT_ID/entity_tags</a></li>
</ul>
